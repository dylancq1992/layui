		...
		<fieldset>
			...
			<table id='table40' class='table'>
				<tr>
					...
					<td><input name='loginname' id='loginname' data-options="required:true" disabled=true
						class='easyui-textbox' type='text' /></td>

				</tr>
				<tr>
					<th style="width:100px;"><span style="color: red;">*</span>性别：</th>
					<td style="width:200px;"><input  class="easyui-combobox" name="sex"   id="sex"
				...
				<tr>
					...
					<td><input name='newpassword' id='newpassword' data-options="validType:['pwdvalidate','length[6,12]']"  
						class='easyui-passwordbox easyui-validatebox' type='text' /></td>
					<th><span style="color: red;">*</span>确认密码：</th>
					<td><input name='newpassword1' id='newpassword1' 
						class='easyui-passwordbox' type='text' />
						</td>
				</tr>
